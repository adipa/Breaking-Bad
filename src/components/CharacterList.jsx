...
import { Typography, Grid, Paper, Select, MenuItem, Button, TextField, InputLabel, FormControl } from "@material-ui/core";
...
const CharacterList = () => {
    ...
    const retrieveByCategory = () => {
        category && CharacterService.getByCategory(category)
            .then((response) => {
                setCharacters(response.data);
    ...
    return (
        <div className={classes.root}>
            <Grid container spacing={1} className={classes.grid}>
                <Grid item xs={12}>
                    <Typography align="center" variant="h2" gutterBottom><b>BREAKING BAD</b></Typography>
                </Grid>
                ...
                <TextField id="outlined-search" label="Search by name" type="search" variant="outlined" onChange={handleNameChange} value={name} />
                                ...
                                <Grid item xs container direction="column" spacing={2}>
                                    <Grid item xs>
                                        ...
                                        {char.occupation.map((occp) => (
                                            <Typography variant="h6" gutterBottom>{occp} </Typography>
                                        ))}
                                    ...
                                    <Grid item>
                                        <Typography variant="body2" style={{ cursor: 'pointer' }}>
                                            <Button variant="contained" color="primary" href={"/" + char.char_id}>
                                                Know More
                                                </Button>
                                        </Typography>
                                    </Grid>
